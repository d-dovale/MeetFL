...
} from './datatable_helper';
import {
    ApperyioDataTableHelperService
} from './apperyio_datatable_helper';
import {
    ModalScreensService
...
@NgModule({
    ...
    providers: [
        ApperyioRestService, ApperyioConfigService, EntityApiService, ApperyioHelperService, ApperyioMappingHelperService, ApperyioDataHelperService, ApperyioNativeHelperService, DataTableHelperService, ApperyioDataTableHelperService
        , ModalScreensService
    ]
})
