...
/* harmony import */ var _Profile__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Profile */ "./src/app/Profile/Profile.ts");
...
ProfilePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _Profile__WEBPACK_IMPORTED_MODULE_6__["Profile"]
        ],
        imports: [
...
let Profile = class Profile {
    ...
    setEditMode(editModeValue) {
        ...
        const items = document.getElementsByClassName('profile-form')[0].getElementsByTagName('ion-item');
    ...
    pageIonViewDidEnter__j_86(event, currentItem) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            /* Invoke data service */
            this.invokeService_get();
        });
    }
    cancelbuttonClick__j_126(event, currentItem) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            /* Run TypeScript */
    ...
    savebuttonClick__j_128(event, currentItem) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            /* Invoke data service */
            this.invokeService_updateProfile();
        });
    }
    editbuttonClick__j_130(event, currentItem) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            /* Run TypeScript */
            this.setEditMode(true);
        });
    }
    invokeService_getProfile(cb) {
        this.Apperyio.getService("GetProfileService").then((service) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!service) {
    ...
    invokeService_updateProfile(cb) {
        this.Apperyio.getService("UpdateProfileService").then((service) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!service) {
                console.log("Error. Service was not found.");
                return;
            }
    ...
    invokeService_update(cb) {
        this.Apperyio.getService("").then((service) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!service) {
                console.log("Error. Service was not found.");
                return;
            }
    ...
    invokeService_get(cb) {
        this.Apperyio.getService("LoginDB_Userdisplay_read_service").then((service) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!service) {
                console.log("Error. Service was not found.");
                return;
            }
            ...
            (res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                let mappingData = {};
                /* Mapping */
                this.userInfo = this.$aio_mappingHelper.updateData(this.userInfo, [], yield this.$aio_mappingHelper.getStorageValue("userData", []));
                /* Run TypeScript */
                console.log(res);
                this.userInfo = res;
                this.profileForm.form.setValue(this.userInfo);
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('profileForm_el', {
        static: false
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
], Profile.prototype, "profileForm_el", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('profileForm', {
        static: true
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
], Profile.prototype, "profileForm", void 0);
Profile = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./Profile.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/Profile/Profile.html")).default,
        selector: 'page-profile',
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./Profile.scss */ "./src/app/Profile/Profile.scss")).default]
    }),
